...
class Language(object):
    ...
    add_to_bookmarks = __addon__.getLocalizedString(32003)
    ...
    bookmarks = __addon__.getLocalizedString(30012)
    select_mirror_for = __addon__.getLocalizedString(30013)
    search_documentations = __addon__.getLocalizedString(30014)
    remove_from_bookmarks = __addon__.getLocalizedString(30015)
    error = __addon__.getLocalizedString(30016)
    documentation_already_in_bookmarks = __addon__.getLocalizedString(30017)
